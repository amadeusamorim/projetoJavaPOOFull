...
//                NumeroDaContaComparator2 comparator = new NumeroDaContaComparator2(); (não há necessidade de se criar um objeto só para um encapsulamento)
//                lista.sort(new NumeroDaContaComparator2()); 
                ...
                Comparator<Conta> comp = new Comparator<Conta> () { // Crio um objeto na CLASSE ANÔNIMA
            		@Override
            		public int compare(Conta c1, Conta c2) {
